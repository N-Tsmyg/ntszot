...
export const metadata: Metadata = {
  ...
  description:
    "WNDW Appliance Repair serves all of San Diego County — 20 cities including San Diego, Chula Vista, La Jolla, Carlsbad, Escondido, and more. $85 diagnostic fee waived if we fix it.",
  alternates: { canonical: `${COMPANY_WEBSITE}/locations/` },
  openGraph: {
    title: `Appliance Repair Service Areas — San Diego County | ${COMPANY_NAME}`,
    description:
      "In-home appliance repair across 20 San Diego County cities. $85 diagnostic fee waived if we fix it. 90-day warranty. 7 days a week.",
      ...
      <section className="bg-brand-navy text-white py-14 sm:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-6 max-w-2xl mx-auto">
            WNDW Appliance Repair serves 20 cities across San Diego County.{" "}
            {DIAGNOSTIC_FEE} diagnostic fee waived if we fix it. {WARRANTY_DAYS}-day
            warranty on every repair. All major brands. 7 days a week.
          </p>
          <a
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {LOCATIONS.map((loc) => (
              <Link
                key={loc.slug}
                href={`/${loc.slug}/`}
                className="group flex flex-col gap-2 rounded-xl border border-gray-200 bg-gray-50 p-5 hover:border-brand-red hover:bg-red-50 transition-colors"
              >
                <div className="flex items-center gap-2">
                  <div className="rounded-full bg-brand-red/10 p-1.5 group-hover:bg-brand-red/20 transition-colors shrink-0">
                ...
                <span className="text-xs font-medium text-brand-red group-hover:underline pl-8">
                  View page →
                </span>
              </Link>
            ))}
      ...
      <section className="py-12 bg-gray-50 border-y border-gray-200">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed mb-6">
            ...
            {DIAGNOSTIC_FEE} diagnostic fee (waived if we repair it), upfront quote
      ...
      <section className="bg-brand-navy py-16 text-center text-white">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <p className="text-white/70 mb-6">
            {DIAGNOSTIC_FEE} diagnostic fee waived if we fix it. {WARRANTY_DAYS}-day
            parts &amp; labor warranty. Available 7 days a week.
          </p>
          <a
            href={COMPANY_PHONE_TEL}
            className="inline-flex items-center gap-3 rounded-lg bg-brand-red px-8 py-4 text-xl font-extrabold text-white hover:bg-brand-red-dark transition-colors shadow-lg"
          ...
          <p className="mt-4 text-sm text-white/60">
            Mon–Sat 7:00 AM–11:00 PM · Sun 8:00 AM–10:00 PM · All major brands
          </p>
        </div>
      </section>
    </>
