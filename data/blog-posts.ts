...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    metaTitle: "Dishwasher Not Draining San Diego | NTSZOT Appliance Repair",
    metaDescription:
      "Dishwasher not draining in San Diego? Check the filter, drain hose, and pump first. $80 service call fee waived if we fix it. Call (619) 488-4477.",
  ...
  },
  {
    ...
    metaDescription: "Repair or replace your broken appliance in San Diego? The 50% rule, appliance-by-appliance breakdown, and why older appliances are often worth keeping. $80 service call fee waived.",
  ...
  },
  {
    ...
    metaTitle: "Oven Not Heating Evenly San Diego | NTSZOT Appliance Repair",
    metaDescription:
      "Oven not heating evenly in San Diego? Failed bake element, weak igniter, or bad sensor. $80 service call fee waived if we fix it. Call (619) 488-4477.",
  ...
  },
  {
    ...
    metaDescription:
      "Spring appliance maintenance checklist for San Diego homeowners — refrigerator coils, dryer vent, washer filter, dishwasher descale, oven igniter. Call (619) 488-4477.",
  ...
  },
  {
    ...
    metaDescription:
      "Samsung refrigerator, washer, dryer & dishwasher repair in San Diego. Error codes explained. $80 service call fee waived if repaired. 60-day warranty. Call (619) 488-4477.",
  ...
  },
  {
    ...
    metaTitle: "Dryer Taking Too Long San Diego | NTSZOT Appliance Repair",
    metaDescription:
      "Dryer taking 2+ cycles in San Diego? Clogged vent, bad heating element, or blown thermal fuse. $80 service call fee waived if we fix it. Call (619) 488-4477.",
