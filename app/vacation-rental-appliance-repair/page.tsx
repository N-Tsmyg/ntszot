...
export const metadata: Metadata = {
  ...
  description:
    "Appliance repair for vacation rentals in San Diego — Airbnb, VRBO, and short-term rentals. Same-day service 6 days a week. $80 service call fee waived if we fix it. 60-day warranty. Call (619) 488-4477.",
  alternates: { canonical: `${COMPANY_WEBSITE}/vacation-rental-appliance-repair/` },
  openGraph: {
    title: "Vacation Rental Appliance Repair San Diego | Airbnb & VRBO",
    description:
      "Fast appliance repair for San Diego vacation rentals. Protect your guest reviews with same-day service, 7-day availability, and a 60-day warranty.",
...
const VR_FAQS = [
  ...
  },
  {
    ...
    answer: `In most cases, yes. We aim for a 3-hour arrival window on same-day calls. We do not charge a surcharge for weekend or evening service — the rate is the same flat ${DIAGNOSTIC_FEE} service call fee (waived if we repair it) regardless of when you call.`,
  },
  {
    question: "How does your warranty protect my vacation rental?",
    answer: `Every repair includes a ${WARRANTY_DAYS}-day parts and labor warranty. If the same issue recurs within ${WARRANTY_DAYS} days of service, our technician returns at no additional charge. This directly protects your guest reviews — a fixed appliance that breaks again within 60 days is our problem, not yours.`,
  },
  {
...
const VR_BENEFITS = [
  {
    ...
    detail:
      "A broken appliance between bookings can force a cancellation or trigger a 1-star review. We aim for same-day arrival in most cases. 6 days a week — no waiting for Monday.",
  },
  {
  ...
  return (
    <>
      ...
      <section className="bg-brand-slate text-white py-14 sm:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-6 max-w-2xl mx-auto">
            Same-day appliance repair for Airbnb and VRBO hosts across San Diego County. Protect your guest reviews. {DIAGNOSTIC_FEE} service call fee waived if we fix it. {WARRANTY_DAYS}-day warranty on every repair.
          </p>
          <a
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="quick-answer rounded-xl border-l-4 border-brand-blue bg-red-50 p-6">
            <p className="font-semibold text-brand-slate leading-relaxed">
              A broken appliance in a San Diego vacation rental can trigger a guest complaint, a bad review, or a booking cancellation. NTSZOT Appliance Repair offers same-day service 6 days a week — including weekends and evenings when guest issues are most likely to surface. Every repair carries a {WARRANTY_DAYS}-day warranty so a fix that fails within that window is our responsibility, not another service call for you.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-brand-slate mb-8">
            How NTSZOT Protects Your Vacation Rental&apos;s Reviews
          </h2>
      ...
      <section className="py-10 bg-gray-50 border-y border-gray-200">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-brand-slate mb-4 text-center">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg bg-red-50 border border-brand-blue/20 p-5">
              <p className="font-semibold text-brand-slate text-sm mb-1">
                Service call fee: {DIAGNOSTIC_FEE} — waived if we repair it
              </p>
      ...
      <section className="bg-brand-slate py-16 text-center text-white">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <p className="text-white/70 mb-6">
            Same-day service 6 days a week. {DIAGNOSTIC_FEE} service call fee waived if we fix it.
