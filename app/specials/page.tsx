...
export const metadata: Metadata = {
  ...
  description: `$${FIRST_SERVICE_DISCOUNT} off your first appliance repair in San Diego. Mention code WELCOME40 when you call. ${DIAGNOSTIC_FEE} diagnostic fee waived if we fix it. ${WARRANTY_DAYS}-day warranty. Call (858) 264-3138.`,
  alternates: { canonical: `${COMPANY_WEBSITE}/specials/` },
  openGraph: {
    title: `Appliance Repair Specials — San Diego | ${COMPANY_NAME}`,
    description: `$${FIRST_SERVICE_DISCOUNT} off your first repair. Mention code WELCOME40 when you call. ${DIAGNOSTIC_FEE} diagnostic fee waived if we fix it.`,
...
const SPECIALS_FAQS = [
  ...
  {
    question: "Does the $40 discount apply to the diagnostic fee?",
    answer: `No — the WELCOME40 discount applies to the repair cost (parts + labor), not to the ${DIAGNOSTIC_FEE} diagnostic fee. However, the diagnostic fee is waived entirely when you proceed with the repair. For a first-time customer, that means $${FIRST_SERVICE_DISCOUNT} off the repair plus the ${DIAGNOSTIC_FEE} diagnostic fee waived — a total of $125 in savings compared to paying both separately.`,
  },
  {
    ...
    <>
      ...
      <section className="py-14 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          {/* Offer card */}
          <div className="rounded-2xl border-2 border-brand-red bg-red-50 p-8 mb-10 text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-brand-red px-4 py-1.5 text-sm font-bold text-white mb-4">
            ...
            <p className="text-xl font-bold text-brand-navy mb-1">Your First Repair</p>
            <p className="text-gray-600 text-sm mb-6">
              Applied to parts + labor. Not valid on diagnostic-only visits.
            </p>
            <div className="inline-block bg-white border-2 border-brand-navy rounded-xl px-8 py-4 mb-6">
              <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">Promo Code</p>
              <p className="text-3xl font-extrabold text-brand-navy tracking-widest">WELCOME40</p>
            </div>
            ...
            <a
              href={COMPANY_PHONE_TEL}
              className="inline-flex items-center gap-3 rounded-lg bg-brand-red px-8 py-4 text-lg font-extrabold text-white hover:bg-brand-red-dark transition-colors shadow-md"
            >
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 mb-10">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm border-b border-gray-200 pb-3">
                ...
                <span className="font-bold text-brand-red">-${FIRST_SERVICE_DISCOUNT}.00</span>
              </div>
              <div className="flex justify-between items-center text-sm border-b border-gray-200 pb-3">
                <span className="text-gray-700">{DIAGNOSTIC_FEE} diagnostic fee — waived when you repair</span>
                <span className="font-bold text-brand-red">-$85.00</span>
              </div>
              <div className="flex justify-between items-center text-base font-extrabold pt-1">
                <span className="text-brand-navy">Total first-visit savings</span>
                <span className="text-brand-red">$125.00</span>
              </div>
            </div>
            <p className="text-xs text-gray-500 mt-3">
              Compared to paying the diagnostic fee separately and not using a promo code. Savings apply when you proceed with a repair.
            </p>
          </div>

          {/* Offer terms */}
          <div className="text-sm text-gray-600 space-y-2 mb-10">
            <p className="font-semibold text-brand-navy">Offer Terms</p>
            <ul className="space-y-1 list-disc list-inside text-gray-500">
              ...
              <li>Mention code <strong className="text-brand-navy">WELCOME40</strong> when scheduling by phone — no coupon or printout required</li>
      ...
      <section className="bg-brand-navy py-16 text-center text-white">
        <div className="mx-auto max-w-2xl px-4">
          <h2 className="text-3xl font-extrabold mb-3">
            Ready to save $125 on your first repair?
          </h2>
