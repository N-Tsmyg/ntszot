...
export const metadata: Metadata = {
  ...
  description:
    "Appliance repair for property managers in San Diego. Fast turnaround, 7 days/week, upfront quotes for remote authorization. $85 diagnostic fee waived if we fix it. 90-day warranty. Call (858) 264-3138.",
  ...
  openGraph: {
    ...
    description:
      "Fast appliance repair for San Diego property managers and landlords. Upfront quotes, 7-day availability, 90-day warranty reduces callbacks.",
...
const PM_BENEFITS = [
  ...
  },
  {
    ...
    detail:
      "Every repair is backed by a 90-day parts and labor warranty. Fewer repeat service calls means lower long-term maintenance spend and fewer friction points with tenants.",
  },
  {
  ...
  {
    heading: `${DIAGNOSTIC_FEE} diagnostic fee — waived if we repair it`,
      ...
      <section className="bg-brand-navy text-white py-14 sm:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-6 max-w-2xl mx-auto">
            Fast in-home repair for rental units across San Diego County. Upfront quotes for remote authorization. 7 days a week. {WARRANTY_DAYS}-day warranty reduces callbacks. All major brands.
          </p>
          <a
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            <div className="rounded-lg border border-gray-200 bg-white p-5 flex justify-between items-center">
              <div>
                <p className="font-semibold text-brand-navy text-sm">Standard appliances</p>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 flex justify-between items-center">
              <div>
                <p className="font-semibold text-brand-navy text-sm">Refrigeration units</p>
      ...
      <section className="py-10 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <a href={`mailto:${COMPANY_EMAIL}`} className="text-brand-red hover:underline">
              {COMPANY_EMAIL}
            </a>{" "}
      ...
      <section className="py-10 bg-white border-t border-gray-100">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/services/appliance-installation/" className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 text-sm text-brand-navy hover:border-brand-red transition-colors">
      ...
      <section className="bg-brand-navy py-16 text-center text-white">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <p className="text-white/70 mb-6">
            {DIAGNOSTIC_FEE} diagnostic fee waived if we repair it. {WARRANTY_DAYS}-day warranty on every repair.
